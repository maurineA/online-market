      ...
      <div className="row">
        ...
        <div className="col-md-6 d-flex align-items-center bg-light">
          <div className="p-5">
            ...
            <div>
              <button onClick={handleSignUp} className="btn btn-primary btn-lg mr-3">Sign Up</button>
              <button onClick={handleLogin} className="btn btn-outline-primary btn-lg">Login</button>
            </div>
          </div>
        </div>
      </div>
